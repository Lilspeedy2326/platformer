...
while not gameover: #GAME LOOP############################################################
    ...
    pygame.draw.rect(screen, (100, 200, 100), (ypos, xpos, 20, 40))
    ...
    #Third platform
    pygame.draw.rect(screen, (200, 0, 100), (300, 550, 100, 20))
     
    #Fourth platform
    pygame.draw.rect(screen, (100, 0, 200), (400, 450, 100, 20))
    
    #Fifth platform
    pygame.draw.rect(screen, (200, 0, 100), (500, 350, 100, 20))
    
    #Sixth platform
    pygame.draw.rect(screen, (100, 0, 200), (600, 250, 100, 20))
    
    #Seventh platform
    pygame.draw.rect(screen, (200, 0, 100), (700, 150, 100, 20))
